...
var techo1, techo1C,techo2, techo2C;
var pira1,pira1C,pira1I; //... nuevo
function iniciarBuffers() {
    //... puntos del cara superior del piramide
    /*

-0.3568,0.4232,0.5000
-0.0064,-0.4864,0.8539
 -0.3568,-0.4864,0.5000
 -0.0064,0.4263,0.8539
     */
    pir1=puntosPiramide([0.3438,0.4232,0.5000,  -0.3568,0.4232,0.5000,  -0.0024,0.4263,0.8499],3); //cara superior
    pir2=puntosPiramide([0.3438,-0.4864,0.5000, -0.3568,-0.4864,0.5000, -0.0064,-0.4864,0.8539],3);  // cara inferior
    techo1=puntosPiramide([ 0.3438,0.4232,0.5000, -0.0024,0.4263,0.8499,   0.3438,-0.4864,0.5000,   -0.0064,-0.4864,0.8539],4);  // techo 1
    techo2=puntosPiramide([-0.3568,-0.4864,0.5000, -0.3568,0.4232,0.5000, -0.0064,-0.4864,0.8539,  -0.0064,0.4263,0.8539],4);  // techo 2

    //... lados del Piramide para el 3D
    pira1=puntosPiramide([
    0.1979 ,0.4263,0.5000,    0.1979,-0.4864,0.5000,   0.1979,-0.4864,0.0000,   0.1979,0.4263,0.0000,//cara1
   -0.2107 ,-0.4864,0.0000,  -0.2107,-0.4864,0.5000,  -0.2107,0.4263,0.5000,   -0.2107,0.4263,0.0000,//     cara2
    0.1979 ,-0.4864,0.5000,   0.1979 ,-0.4864,0.0000, -0.2107,-0.4864,0.0000,  -0.2107 ,-0.4864,0.5000, // cara 3 
    0.1979 ,0.4263,0.0000,    0.1979 ,0.4263,0.5000,  -0.2107,0.4263 ,0.5000,  -0.2107 ,0.4263,0.0000, //   cara 4  
    0.1979,-0.4864,0.0000,    0.1979,0.4263,0.0000,   -0.2107,0.4263,0.0000,   -0.2107, -0.4864, 0.0000 // cara 5
    ],25);
         
    // Color del Piramide
    pir1C=colorPiramide([0.0, 1.0, 0.0, 1.0],4);
    pir2C=colorPiramide([0.0, 1.0, 0.0, 1.0],4); 
    // Color para el techo
    techo1C=colorPiramide([1.0, 0.0, 0.0, 1.0],4);
    techo2C=colorPiramide([1.0, 0.0, 0.0, 1.0],4);
...
function dibujarEscena() {
   ...
   piramide(techo1, techo1C, [0.0, 0.0, -7.0], rotar*Math.PI/180, [1, 1, 0], [1.0, 1.0, 1.0]);
   piramide(techo2, techo2C, [0.0, 0.0, -7.0], rotar*Math.PI/180, [1, 1, 0], [1.0, 1.0, 1.0]);
